...
const whatsappUrl = 'https://wa.me/94770000000?text=Hello%20Prasad%2C%20I%27d%20like%20to%20enquire%20about%20your%20artwork.'
...
export default function WhatsAppButton() {
  ...
  return (
    <div className={`whatsapp ${open ? 'is-open' : ''}`}>
      ...
      >
        <span className="whatsapp-button__label">Enquire</span>
